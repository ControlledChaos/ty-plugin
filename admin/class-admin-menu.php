...
class Admin_Menu {
    ...
    public function __construct() {
        ...
        if ( typ_acf_options() ) {
            ...
            $options = get_field( 'typ_admin_hide_links', 'option' );
        ...
        // Get links option.
        if ( typ_acf_options() ) {
            $links = get_field( 'typ_links_manager', 'option' );
        } else {
            $links = get_option( 'typ_hide_links' );
        }
    ...
    public function hide() {
        ...
        if ( typ_acf_options() ) {
            ...
            // Get options.
            $appearance = get_option( 'typ_hide_appearance' );
            $plugins    = get_option( 'typ_hide_plugins' );
            $users      = get_option( 'typ_hide_users' );
            $tools      = get_option( 'typ_hide_tools' );
    ...
    public function menus_widgets() {
        ...
        if ( typ_acf_options() ) {
            ...
            $menus_link   = get_field( 'typ_menus_position', 'option' );
            $widgets_link = get_field( 'typ_widgets_position', 'option' );
        ...
        // If ACF is not active.
            ...
            $menus_link   = get_option( 'typ_menus_position' );
            $widgets_link = get_option( 'typ_widgets_position' );
