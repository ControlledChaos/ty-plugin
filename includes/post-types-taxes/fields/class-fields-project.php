			...
			acf_add_local_field_group( [
				...
				'fields' =>[
					...
					[
						...
						'label'             => __( 'Poster Image', 'ty-plugin' ),
						'name'              => 'typ_poster_image',
						'type'              => 'image',
						'instructions'      => __( 'The poster image uses a 2:3 aspect ratio, taller than wide. The minimum size is 426 pixels wide by 640 pixels high. Ideal is 853x1280 or greater.', 'ty-plugin' ),
						'required'          => 1,
						'conditional_logic' => 0,
						'wrapper'           => [
							'width' => '',
					...
					[
						...
						'label'             => __( 'Video Image', 'ty-plugin' ),
						'name'              => 'typ_video_image',
						'type'              => 'image',
						'instructions'      => __( 'Optional. The video image uses a 16:9 aspect ratio, the same as HD video. If no image is selected then the screenshot from Vimeo will be used. This can be used to replace an inferior image provided by Vimeo. Minimum 960 X 540 pixels.', 'ty-plugin' ),
						'required'          => 0,
						'conditional_logic' => 0,
						'wrapper'           => [
							'width' => '',
